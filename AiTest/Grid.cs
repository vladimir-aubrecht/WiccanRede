...
namespace WiccanRede.AI
{
    ...
    public class Grid : WiccanRede.AI.IWalkable
    {
        ...
        public Grid(Bitmap bmp, Panel gridPanel)
        {
            this.size = new Size(bmp.Width, bmp.Height);
            this.fields = new Field[size.Width, size.Height];
            this.fieldWidth = gridPanel.Width / size.Width;
            this.fieldHeight = gridPanel.Height / size.Height;
            this.bmp = bmp;
            ...
            this.final = new Bitmap(gridPanel.Width, this.gridPanel.Height);
        ...
        public Bitmap PaintGrid()
        {
            ...
            //draw ship
            //this.ship.Draw(gBmp);
            this.final.Save("Bmp.jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
            return this.final;
        }
        ...
        public Microsoft.DirectX.Vector3 GetPlayerPosition3D()
        {
